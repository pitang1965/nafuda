...
- [ ] **Phase 0: プロトタイプ** - DB・認証なしのフロントエンドのみでコアUXを検証する
...
Plans:
- [ ] 01-01: TanStack Start移行 + Neon Postgres + Drizzle ORM + Better Auth セットアップ
- [ ] 01-02: Google / Facebook OAuth実装・セッション管理（iOS 7日間ストレージ失効対策含む）
- [ ] 01-03: プロフィールCRUD・複数ペルソナ・フィールド単位公開/非公開制御
- [ ] 01-04: 推し・ジャンルタグ登録・同担拒否フラグ実装
