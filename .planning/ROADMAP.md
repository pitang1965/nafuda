...
Plans:
- [ ] 02-01-PLAN.md — DB スキーマ（events + event_checkins テーブル）+ イベントサーバー関数4本
- [ ] 02-02-PLAN.md — チェックインUI（/_protected/events、GPS取得、EventCheckinCard）
- [ ] 02-03-PLAN.md — 公開イベント参加者ページ（/e/$slug、同担フィルタ、未ログイン制限）
