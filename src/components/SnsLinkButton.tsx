...
function PlatformIcon({ platform }: { platform: string }) {
  ...
  switch (platform) {
    ...
    case "pixiv":
      return (
        <svg className={cls} viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.1 0 2-.9 2-2 0-.54-.2-1.03-.52-1.42-.29-.36-.47-.83-.47-1.29 0-1.1.9-2 2-2h2.36c3.1 0 5.63-2.53 5.63-5.63C23 6.22 18.04 2 12 2zM6 10c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm2-6c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm8 0c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm2 6c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" />
        </svg>
      );
    default:
      return (
