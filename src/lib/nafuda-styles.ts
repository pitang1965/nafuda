export type NafudaStyleId = 'purple' | 'sakura' | 'moon' | 'ocean' | 'sunset'
export type FrameId = 'sakura' | 'moon'
...
export const NAFUDA_STYLES: NafudaStyleDef[] = [
  ...
  },
  {
    ...
    fontUrl: 'https://fonts.googleapis.com/css2?family=Zen+Maru+Gothic:wght@400;700&display=swap',
    frameId: 'sakura',
    isFree: true,
  },
  {
...
export function getNafudaStyle(styleId: string | null | undefined): NafudaStyleDef | null {
