...
export const MOCK_PROFILE: MockProfile = {
  ...
  snsLinks: [
    {
      platform: "x",
      url: "https://x.com/sumire_example",
      handle: "@sumire_example",
    },
    {
      platform: "instagram",
      url: "https://instagram.com/sumire_example",
      handle: "sumire_example",
    },
  ],
...
export const MOCK_PARTICIPANTS: MockProfile[] = [
  MOCK_PROFILE,
  {
    ...
    snsLinks: [
      {
        platform: "instagram",
        url: "https://instagram.com/aoi_example",
        handle: "aoi_example",
      },
    ],
  ...
  },
  {
    ...
    snsLinks: [
      {
        platform: "x",
        url: "https://x.com/koharu_example",
        handle: "@koharu_example",
      },
    ],
